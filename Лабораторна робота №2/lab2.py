...
def homogeneity():
    ...
    def romanovskyi(dispertion):
        ...
        if (r_uv1 < romanovskyi_cr[m]) and (r_uv2 < romanovskyi_cr[m]) and (r_uv3 < romanovskyi_cr[m]): return False
        else: return True
...
# Оскільки в таблиці відсутні значення від 16 до 19, ймовірність однорідності дисперсії за цих значень
# аж ніяк не 0.99, але мені довелось заповнити ці пробіли
